...
alter table Especie
alter column habilidades varchar(100)
...
insert into Personaje(idPersonaje,nombre, fechaNacimiento, bastardo, estado, fkCasa, fkEspecie, fkrelacionFamiliar) values
	...
	(2003,'Tywin Lannister', '1490.01.01', 0, 'vivo',2,100, 3003),
	(2004,'Jamie Lannister', '1510.01.01', 0, 'vivo',2,100,3004),
	(2005,'Theon Greyjoy', '1550.01.01', 0, 'vivo',4,100,3005);

update Personaje
set fkrelacionFamiliar = 3003
where idPersonaje = 2003

insert into relacionFamiliar(padre, madre, idFamilia) values
	('Rickard Stark', 'Lyarra Stark', 3000),
	('Eddard Stark', null, 3001),
	('Tytos Lannister', 'Jeyne Lannister', 3003),
	('Tywin Lannister', 'Joanna Lannister', 3004),
	('Balon Greyjoy', 'Alannys Greyjoy', 3005)
...
insert into Guerra(idGuerra, lugar, anio, cantidadMuertes) values
	...
	(298, 'Guerra de los cinco reyes', 298, 20500),
	(129, 'La danza de los dragones', 129, 30000),
	(305, 'La batalla de los bastardos', 305, 18000)
...
insert into Especie(idEspecie,nombreCientifico, habilidades, hostil, existe) values
	...
	(101,'White Walker',null, 1, 1),
	(102,'Espectro',null, 1, 0),
	(103,'Hijo del Bosque',null, 0, 1),
	(104,'Gigante',null ,0, 1);
